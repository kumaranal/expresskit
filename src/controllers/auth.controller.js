...
const generateAccessAndRefereshTokens = (username, unique_id_key) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const accessToken = yield (0, jwt_1.generateAccessToken)({ username, unique_id_key });
...
exports.signUp = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.signIn = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { username, password } = req.body;
    const user = yield auth_1.default.findOne({ where: { username } });
    if (!user || !(yield bcrypt_1.default.compare(password, user === null || user === void 0 ? void 0 : user.dataValues.password))) {
...
exports.forgotPassword = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.refreshAccessToken = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { accessToken, refreshToken } = yield (0, exports.generateAccessAndRefereshTokens)(user.username, user.unique_id_key);
    return res
        .status(200)
        .cookie("accessToken", accessToken, options)
        .cookie("refreshToken", refreshToken, options)
