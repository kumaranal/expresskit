...
exports.updateUserDetails = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.deleteUserDetails = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const auths = yield auth_1.default.destroy({ where: { unique_id_key: uniqueIdKey } });
    if (!auths) {
        throw (0, customError_1.createCustomError)("Invalid unique_id_key", 401);
    }
    return res
...
exports.profileDetails = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.profileDetailsByUserId = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const uniqueIdKey = req.params.id;
...
exports.resetPassword = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [user] = yield auth_1.default.update({ password: hashedPassword }, { where: { unique_id_key: uuid } });
    if (!user) {
        throw (0, customError_1.createCustomError)("Invalid uuid", 401);
    }
    return res
...
exports.getAllUserData = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const users = yield auth_1.default.findAll();
    return res
        .status(200)
        .json(new ApiResponse_1.ApiResponse(200, "User data retrieved Successfully", users));
}));
exports.signout = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    res.clearCookie("token", { httpOnly: true, secure: true });
    return res.status(200).json(new ApiResponse_1.ApiResponse(200, "Logged out successfully"));
}));
exports.refreshAccessToken = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.checkResult;
    const { accessToken, refreshToken } = yield generateAccessAndRefereshTokens(user.username, user.unique_id_key);
    return res
        .status(200)
...
exports.uploadFile = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const RETRY_LIMIT = 3;
    for (let attempt = 1; attempt <= RETRY_LIMIT; attempt++) {
        try {
            ...
            const publicUrl = yield (0, fileUpload_1.uploadFileToSupabase)(fileBuffer, file.filename);
...
exports.downloadFile = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const RETRY_LIMIT = 3;
    for (let attempt = 1; attempt <= RETRY_LIMIT; attempt++) {
        try {
            ...
            if (user) {
                const { imageName, mimeType, data } = yield (0, fileDownload_1.default)(user.image, res);
...
exports.userNotification = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { token, title, body } = req.body;
        const notification = yield (0, sendNotification_1.sendNotification)(token, title, body);
        if (notification) {
            return res
                .status(200)
...
exports.uploadImageBase64 = (0, asyncHandeler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let attempt = 1; attempt <= RETRY_LIMIT; attempt++) {
        try {
            ...
            const publicUrl = yield (0, fileUpload_1.uploadFileToSupabaseBase64)(buffer, image);
            const [updated] = yield user_1.default.update({
                image: publicUrl,
            }, {
                where: {
